...
<%@attribute name="index"%>
	...
	<ul class="list-unstyled">
		...
		<li class="nav-header"><a href="#" data-toggle="collapse"
								  data-target="#categoryImage">
			<h5>
				Image News management <i class="glyphicon glyphicon-chevron-down"></i>
			</h5>
		</a>
			<ul class="list-unstyled collapse in" id="categoryImage">
				<%--<li><a href="<%=request.getContextPath() %>/admin/category.jsp"> <i class="glyphicon glyphicon-list-alt"></i>--%>
					<%--Category </a></li>--%>
				<%--<li><a href="<%=request.getContextPath() %>/admin/news.jsp"> <i class="glyphicon glyphicon-pencil"></i>--%>
					<%--News </a></li>--%>
				<li><a href="<%=request.getContextPath() %>/admin/image-news-review.jsp"> <i class="glyphicon glyphicon-save"></i>
					Image News Review </a></li>
			</ul>
		</li>
