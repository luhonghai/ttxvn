<%@ page import="com.project.ttxvn.constant.Common" %>
...
<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content">
      <div class="modal-header">
          ...
          <h1 class="text-center"><%=Common.APP_NAME%></h1>
      </div>
      <div class="modal-body">
          <form class="form col-md-12 center-block" action="<%=request.getContextPath() %>/login-handler.jsp">
